...
namespace SpreadsheetUtilities
{
    ...
    {
        /// <summary>
        /// this keeps track of dependents.  The key is the object an intrest and the hash set is all
        /// of the dependents of the key
        /// </summary>
        private Dictionary<string, HashSet<string>> dependentDict;
        /// <summary>
        /// this keeps track of dependees.  The key is the object an intrest and the hash set is all
        /// of the dependees of the key
        /// </summary>
